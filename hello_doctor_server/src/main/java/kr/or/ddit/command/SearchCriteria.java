...
public class SearchCriteria {
	...
	public String getChkSelectMine() {
		return chkSelectMine;
	}

	public void setChkSelectMine(String chkSelectMine) {
		this.chkSelectMine = chkSelectMine;
	}
